        ...
        <Link href="/" className="flex items-center gap-3 md:gap-4 group shrink-0">
          <div className="relative w-10 h-10 md:w-12 md:h-12 flex items-center justify-center transition-all duration-500 shrink-0">
            ...
            <img 
              src="/logo-icon.png" 
              alt="Corterion Icon" 
              className={`w-8 h-8 md:w-10 md:h-10 object-contain relative z-10 transition-all duration-500 shrink-0 ${scrolled ? '' : 'brightness-0 invert'}`} 
          ...
          <img 
            src="/logo-text.png" 
            alt="Corterion" 
            className={`h-5 md:h-6 w-auto object-contain transition-all duration-500 shrink-0 ${scrolled ? '' : 'brightness-0 invert'}`} 
            onError={(e) => { e.currentTarget.style.display = 'none'; }} 
          />
        </Link>
